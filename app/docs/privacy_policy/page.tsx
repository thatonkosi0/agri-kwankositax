...
export default async function PrivacyPolicy() {
  return (
    <div className="prose prose-slate max-w-none">
      ...
      <p className="text-slate-700 mb-3">We collect the following types of data when you use Agri-KwankosiTax:</p>
      ...
      <ul className="list-disc pl-6 mb-6 space-y-2 text-slate-700">
        <li>Create and manage your Agri-KwankosiTax account</li>
      ...
      <p className="text-slate-700 mb-6 leading-relaxed">
        By using Agri-KwankosiTax, you consent to the transfer of relevant data to these third-party providers for the purpose
      ...
      <p className="text-slate-700 mb-6 leading-relaxed">
        Agri-KwankosiTax does <strong className="text-slate-800">not use tracking cookies</strong> or third-party analytics. We
      ...
      <p className="text-slate-700 mb-6 leading-relaxed">
        Agri-KwankosiTax is <strong className="text-slate-800">not intended for users under the age of 18</strong>. We do not
